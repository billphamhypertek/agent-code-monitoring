      ...
      submenu: [
        {
          ...
          click: () =>
            void shell.openExternal("https://github.com/billphamhypertek/agent-code-monitoring"),
        },
        {
          label: "Report an Issue",
          click: () =>
            void shell.openExternal(
              "https://github.com/billphamhypertek/agent-code-monitoring/issues/new/choose"
            ),
        },
        {
