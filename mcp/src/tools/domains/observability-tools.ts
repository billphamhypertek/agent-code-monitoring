...
export function registerObservabilityTools(context: ToolContext): void {
  ...
  register(
    ...
    "Check health of the local Agent Code Monitoring API.",
    {},
