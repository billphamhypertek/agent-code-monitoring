...
Complete REST API and WebSocket documentation for Agent Code Monitoring.
...
The Agent Code Monitoring API provides programmatic access to Claude Code session monitoring data.
...
ws.onopen = () => {
  console.log('Connected to Agent Code Monitoring');
};
...
The Agent Code Monitoring API provides:
