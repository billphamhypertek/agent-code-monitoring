...
webpush.setVapidDetails(
  "https://github.com/billphamhypertek/agent-code-monitoring",
  vapidKeys.publicKey,
...
async function sendPushToAll(db, title, body) {
  ...
  const payload = JSON.stringify({
    title,
    body,
    icon: "https://raw.githubusercontent.com/billphamhypertek/agent-code-monitoring/main/client/public/favicon.ico",
    badge:
      "https://raw.githubusercontent.com/billphamhypertek/agent-code-monitoring/main/client/public/favicon.ico",
    silent: false,
    sound: "default",
  });
