/**
 * @file Sidebar provider for Agent Code Monitoring VSCode extension
...
class DashboardWebviewProvider {
  ...
  handleMessage(msg) {
    ...
    switch (msg.command) {
      case "openDashboard":
        vscode.commands.executeCommand("agent-code-monitoring.openDashboard", msg.target || "");
        break;
      case "openInBrowser":
        vscode.commands.executeCommand("agent-code-monitoring.openInBrowser");
        break;
      case "refresh":
        vscode.commands.executeCommand("agent-code-monitoring.refreshStatus");
        break;
      case "clearHistory":
        vscode.commands.executeCommand("agent-code-monitoring.clearHistory");
        break;
      case "ready":
