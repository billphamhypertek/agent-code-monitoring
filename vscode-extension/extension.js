/**
 * @file Main extension file for Agent Code Monitoring VSCode extension
...
function activate(context) {
  ...
  statusBarItem.command = "agent-code-monitoring.openDashboard";
  ...
  let openDashboard = vscode.commands.registerCommand(
    "agent-code-monitoring.openDashboard",
    async (target) => {
  ...
  let openInBrowser = vscode.commands.registerCommand(
    "agent-code-monitoring.openInBrowser",
    async () => {
            ...
            <div class="setup-guide">
                ...
                <div class="timeline">
                    <div class="t-step">
                        ...
                        <div class="t-code">git clone https://github.com/billphamhypertek/agent-code-monitoring.git
...
npm run setup</div>
            ...
            <div class="side-panel">
                ...
                <a href="https://billphamhypertek.github.io/agent-code-monitoring/" class="btn btn-secondary">
                    View Documentation
                </a>
            </div>
        </div>
        ...
        <div class="footer">
            <a href="https://github.com/billphamhypertek/agent-code-monitoring">GitHub</a>
            <a href="https://billphamhypertek.github.io/agent-code-monitoring/">Wiki</a>
            <a href="https://github.com/billphamhypertek/agent-code-monitoring/issues">Support</a>
        </div>
    </div>
</body>
</html>`;
