# Contributing to Agent Code Monitoring
...
You sign **once** — the signature covers all of your current and future contributions, so returning contributors are never asked again. If you contribute **on behalf of a company**, contact the maintainer ([@billphamhypertek](https://github.com/billphamhypertek)) to arrange a Corporate CLA first.
